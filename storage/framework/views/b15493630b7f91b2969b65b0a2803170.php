...
<?php $__env->startSection('content'); ?>
    <div class="h-screen flex items-center justify-center">
        ...
        <div class="flex flex-col justify-center items-center bg-yellow-400 rounded-lg shadow-lg w-max-w-6xl p-8">
            ...
            <!-- Login Form -->
            <form id="loginForm" class="w-full px-8" action="<?php echo e(route('user.login')); ?>" method="POST">
                <?php echo csrf_field(); ?>
    ...
    <script>
        ...
        signUpForm.addEventListener('submit', async function(event) {
            ...
            try {
                ...
                const response = await fetch("<?php echo e(route('user.signUp')); ?>", {
                    method: 'POST',
                    headers: {
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\C14230250_JESSICA_CHANDRA_UAS_TEKWEB_LAT\resources\views/login.blade.php ENDPATH**/ ?>